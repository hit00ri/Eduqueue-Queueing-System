...
require_once __DIR__ . "/api/index-b.php";
...
<body>
    ...
    <div class="login-container">
        ...
        <form method="post" class="mb-3">
            ...
            <p class="forgot-password"><a href="includes/forget_password.php" class="forgot-password">Forgot
                    Password?</a></p>

            <p><a href="includes/open_live_queue.php" class="btn btn-outline-primary"
                    style="display:flex; justify-content:center;">View Live Queue</a></p>
