...
<style>
  ...
  .confirm-logout-dialog {
    ...
    border-radius: 10px;
    box-shadow: 0 12px 40px rgba(3, 61, 122, 0.25);
    overflow: hidden;
  ...
  .confirm-logout-header {
    padding: 14px 18px;
    background: linear-gradient(90deg, var(--accent), #003d7a);
    color: white;
  }

  .confirm-logout-header h5 {
    margin: 0;
    font-size: 1rem;
  }
