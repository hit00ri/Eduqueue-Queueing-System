        ...
        <div class="header-actions d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-3 flex-wrap">
                ...
                <div class="d-flex gap-2">
                    <a href="../../includes/user-management/add-staff.php"
                        class="btn btn-primary d-flex align-items-center gap-2">
                        <i class="bi bi-person-plus"></i> Add Staff
                    </a>
                    <a href="../../includes/user-management/add_student.php"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle me-3 bg-light text-primary d-flex align-items-center justify-content-center rounded-circle"
                                        ...
                                        <td>
                                            <span
                                                class="badge <?= $user['role'] === 'admin' ? 'badge-admin' : 'badge-cashier' ?> text-white">
                                                <i
                                                    class="bi bi-<?= $user['role'] === 'admin' ? 'shield-check' : 'cash' ?> me-1"></i>
                            ...
                            <?php else: ?>
                                <?php foreach ($studentsOnly as $stu): ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle me-3 bg-light text-success d-flex align-items-center justify-content-center rounded-circle"
                                                    style="width: 40px; height: 40px;">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                                <div>
