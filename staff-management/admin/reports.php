          ...
          <div class="card-body">
            <div class="row text-center">
              ...
              <div class="col-md-2">
                <h6>Avg Wait Time</h6>
                <h4>
                  <?= $todaySummary['avg_wait_time'] ? number_format($todaySummary['avg_wait_time'] / 60, 1) . 'm' : 'N/A' ?>
                </h4>
              </div>
              <div class="col-md-2">
                <h6>Total Revenue</h6>
              ...
              <div class="col-md-2">
                ...
                <h4>
                  <?= $todaySummary['avg_service_time'] ? number_format($todaySummary['avg_service_time'] / 60, 1) . 'm' : 'N/A' ?>
                </h4>
              </div>
            </div>
          </div>
